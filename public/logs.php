...
<body class="dashboard-body">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <?php if ($auth->isPrincipal()): ?>
                <a href="principal_dashboard.php" class="nav-item">
                    <i class="fa-solid fa-chart-line"></i>
                    <span>Summary View</span>
                </a>
            <?php endif; ?>
            <?php if ($auth->isFaculty()): ?>
            ...
            <?php if ($viewLog): ?>
                <div class="log-meta">
                    ...
                    <div style="display: flex; gap: 15px; align-items: center;">
                        <input type="text" id="logSearch" placeholder="Filter by Subject or Email..."
                            style="padding: 8px 15px; border-radius: 8px; border: 1px solid #444; background: #2d2d2d; color: white; outline: none; width: 250px;">
                        <h3>Viewing: <?php echo htmlspecialchars($viewLog); ?></h3>
                    </div>
                </div>
