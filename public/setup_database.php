 ...
 * This file self-locks after first successful run — protected by a lock file.
 */

// ── Lock-file guard — blocks re-runs after first successful setup ──────────
$lockFile = __DIR__ . '/../setup_done.lock';
if (file_exists($lockFile)) {
    http_response_code(403);
    die('<h2 style="font-family:sans-serif;color:#c00;padding:40px">403 Forbidden — Setup has already been completed. This page is locked.</h2>');
}
...
<body>
    <div class="box">
        ...
        try {
            ...
            $success = true;
            // Auto-create lock file — setup_database.php will refuse to run again
            ...
            $messages[] = ['warn', 'This setup page is now <strong>permanently locked</strong>. Any future visit will return 403 Forbidden.'];
        } catch (PDOException $e) {
